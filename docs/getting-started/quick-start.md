...
var lines = [
  ...
  {type:'blank'},
  {type:'comment', text:'# Cloudflare domain with wildcard A record → server IP'},
  ...
  {type:'comment', text:'# ✓ Ubuntu/Debian control node (tools installed below)'},
  {type:'blank'},
  ...
  {type:'blank'},
  {type:'comment', text:'# Installs uv, task, Node.js (fnm), Bitwarden CLI, Ansible'},
  {type:'cmd', text:'bash setup.sh'},
  {type:'out', text:'══ uv ══'},
  {type:'out', text:'  –  uv 0.10.11 already installed'},
  {type:'out', text:'══ Task runner ══'},
  {type:'out', text:'  →  Installing task to ~/.local/bin...'},
  {type:'out', text:'  ✔  task installed'},
  {type:'out', text:'══ Node.js ══'},
  {type:'out', text:'  Install Node.js via fnm? [Y/n] Y'},
  {type:'out', text:'  ✔  Node v22.14.0 installed via fnm'},
  {type:'out', text:'══ Bitwarden CLI ══'},
  {type:'out', text:'  ✔  bw installed'},
  {type:'out', text:'══ Python dependencies ══'},
  {type:'out', text:'  ✔  Dependencies installed (.venv)'},
  {type:'out', text:'══ Ansible Galaxy collections ══'},
  {type:'out', text:'  ✔  Ansible collections installed'},
  {type:'out', text:'══ Config files ══'},
  {type:'out', text:'  ✔  Created .env (edit before use)'},
  {type:'blank'},
